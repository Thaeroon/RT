...
void	apply_filter(const t_camera *camera, t_vector *col)
{
	...
	{
		col_tmp = *col;
		col->x = (col_tmp.x * 0.393) + (col_tmp.y * 0.769) + (col_tmp.z * 0.189);
		col->y = (col_tmp.x * 0.349) + (col_tmp.y * 0.686) + (col_tmp.z * 0.168);
		col->z = (col_tmp.x * 0.272) + (col_tmp.y * 0.534) + (col_tmp.z * 0.131);
	}
}